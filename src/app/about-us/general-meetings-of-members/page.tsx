      ...
      <section className="pt-6 pb-[50px] bg-netural_100 text-[16px] md:text-[18px] text-primary_700">
        <div className="div-container flex flex-col gap-6">
          ...
          <p>
            ...
            загальні збори кредитної спілки, що відбудуться 25 червня 2024року.
            Місце проведення - м.Тернопіль, вул.І.Франка 23. Початок реєстрації
            о 15.30, закінчення реєстрації о 16.00. Початок зборів о 16.10.
            Детальніше{" "}
            <Link
              href="https://docs.google.com/document/d/1WB4kve9oRxZiDc_NAwKQKvArEZKCuXLx/edit?usp=drive_link&ouid=105532657333642908737&rtpof=true&sd=true"
